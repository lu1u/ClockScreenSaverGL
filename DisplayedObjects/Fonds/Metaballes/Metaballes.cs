...
namespace ClockScreenSaverGL.DisplayedObjects.Metaballes
{
    ...
    {
        #region Parametres
        private const string COULEURS_INVERSE = "CouleursInversees";
        private const string NEGATIF = "NegatifCouleurs";
        private const string CAT = "Metaballes";
        private CategorieConfiguration c;
        protected double RATIO_COULEURS;
        protected bool COULEUR_INVERSES;
        protected bool NEGATIF_COULEURS;
        #endregion
