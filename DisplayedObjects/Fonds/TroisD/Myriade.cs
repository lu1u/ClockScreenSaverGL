...
{
	internal class Myriade : TroisD, IDisposable
	{
		public const string CAT = "Myriade";
		protected CategorieConfiguration c;
		private const float VIEWPORT = 20f;
		private readonly float[] fogcolor = { 0, 0, 0, 1 };
		private bool ADDITIVE;
		private byte ALPHA_ETOILE;
		private float DISTANCE;
		private float FOG_DENSITY;
		private int NB_POINTS;
		private int FREQUENCE_TRI;
		...
		private static Vecteur3D getCameraPos(OpenGL gl)
		{
