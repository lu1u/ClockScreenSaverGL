...
namespace ClockScreenSaverGL.DisplayedObjects.Fonds.TroisD
{
	internal class Molecule : MateriauGlobal, IDisposable
	{
		...
		private readonly int TAILLE_FONTE;
		...
		private readonly int DETAIL_ATOMES;
		private readonly int DETAIL_LIENS;
		...
		private List<Atome> _atomes = new List<Atome>();
		private List<Lien> _liens = new List<Lien>();
