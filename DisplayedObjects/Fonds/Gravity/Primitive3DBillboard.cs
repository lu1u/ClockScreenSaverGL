...
namespace ClockScreenSaverGL.DisplayedObjects.Fonds.Gravity
{
    sealed public class Primitive3DBillboard : Primitive3D
    {
        ...
        public static void CalculePoints(OpenGL gl, Vecteur3D Position, float taille, out Vecteur3D vPoint0, out Vecteur3D vPoint1, out Vecteur3D vPoint2, out Vecteur3D vPoint3)
        {
            float[] mat = new float[16];
            gl.GetFloat(OpenGL.GL_MODELVIEW_MATRIX, mat);
