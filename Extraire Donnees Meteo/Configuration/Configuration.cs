...
{
    public class FichiersConfiguration : IDisposable
    {
        ...
        // Singleton
        private static FichiersConfiguration _instance;

        // Dictionnaire des categories de configuration
        private Dictionary<string, CategorieConfiguration> _categories;

        public static FichiersConfiguration getInstance()
        {
            if ( _instance == null )
                return _instance = new FichiersConfiguration();
        ...
        {
            FichiersConfiguration conf = getInstance();
